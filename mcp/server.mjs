/**
 * codex-dsh-routing-suite MCP server (stdio, zero dependencies).
 *
 * Tools:
...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Run the codex-dsh-routing-suite unit tests and hook scenario tests; returns a PASS/FAIL summary.',
